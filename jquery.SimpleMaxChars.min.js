...
return this.each(function(){var $this=$(this);var messageCount=$('.'+opts.messageClass).length;messageCount++;$this.after('<span id="simple-maxchars-'+messageCount+'"></span>');var $container=$('#simple-maxchars-'+messageCount);var maxLength=opts.maxChars;if(typeof maxLength==="undefined"){if(typeof $this.attr('maxlength')==="undefined"||$this.attr('maxlength')===""){maxLength=opts.defaultMaxChars;$this.prop('maxLength',maxLength);}
